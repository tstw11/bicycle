		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a class="nav-link" href="#">라이딩 추천 경로</a></li>
					<li class="nav-item">
						<c:choose>
					...
					<li class="nav-item"><a class="nav-link"
						href="./join_member_page.do">회원가입</a></li>
					<li class="nav-item">
						<c:choose>
							<c:when test="${!empty sessionUserData }">
								<a class="nav-link" href="./track.do">내 주행 기록</a>
							</c:when>
						</c:choose>
				</ul>
			</div>
		...
		<div class="row">
			<div class="col-1"></div>
				<div class="col">
					<c:choose>
						<c:when test="${!empty sessionUserData }">
							${sessionUserData.member_nick } 주행 기록
						</c:when>
					</c:choose>
				</div>
			<div class="col-1"></div>	
			...
			<table class="table table-hover">
				<thead>
					<tr>
						...
						<th scope="col">출발 장소</th>
						<th scope="col">도착 장소</th>
						<th scope="col">평균 속도</th>
						<th scope="col">최고 속도</th>
						<th scope="col">칼로리</th>
						<th scope="col">이동 거리</th>
					</tr>
				</thead>
