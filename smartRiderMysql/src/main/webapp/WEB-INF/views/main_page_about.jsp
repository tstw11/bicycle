		...
		<div class="row mt-3">
			<div class="col">
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							<th scope="col" role="align">번호</th>
							<th scope="col" role="alert">제목</th>
							<th scope="col" role="alert">글쓴이</th>
							<th scope="col" role="alert">조회수</th>
							<th scope="col" role="alert">작성일</th>
						</tr>
					</tbody>
					<tbody>
						<c:forEach items="${xxx }" var="aaa">
							<tr>
								...
								<td><fmt:formatDate value="${aaa.boardVo.board_writedate }" pattern="yyyy-MM-dd"></fmt:formatDate></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
